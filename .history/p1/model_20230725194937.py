...
class NetDJ(nn.Module):
    def __init__(self, n):
        ...
        self.cir1 = dq.Circuit(self.n+1)
        self.cir2 = dq.Circuit(self.n+1)
        self.circuit1()
        self.circuit2()
    ...
    def forward(self, oracles):
        ...
        for oracle in oracles:
            cir_o = dq.QubitCircuit(self.n+1)
...
class Net(nn.Module):
    def __init__(self, n):
        super().__init__()
        self.n = n
        self.cir1 = dq.QubitCircuit(self.n+1)
        self.cir2 = dq.QubitCircuit(self.n+1)
        self.circuit1()
        self.circuit2()
