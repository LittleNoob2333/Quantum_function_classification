...
class Net(nn.Module):
    ...
    def circuit1(self):
        ...
        self.cir1.rylayer()
        #self.cir1.u3layer()
        self.strong_entangle()
        self.cir1.barrier()
        #self.cir1.BasicEntangleLayer()
        '''
    ...
    def circuit2(self):
        self.cir2.rxlayer([0,1,2,3])
        self.cir2.rzlayer([0,1,2,3])
        self.cir2.rylayer([0,1,2,3])
        #self.cir2.u3layer([0,1,2,3])
        self.strong_entangle1()
        #self.entangle1(self.n)
        self.cir2.barrier()
        """
